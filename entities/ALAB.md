...
**Computex 2026 press conference formally scheduled for June 3, 10:00–11:00am Taipei — first live public Scorpio X 320 Lane + PCIe 6 optics demo:** Astera Labs filed a press release on May 27 confirming attendance at Computex 2026 at the Taipei Nangang Exhibition Center, Hall 1 (TaiNEX 1), Room 303. Key demonstrations: (1) first public demo of the 320-lane Scorpio X-Series Smart Fabric Switch; (2) ultra-low latency linear optical connectivity; (3) COSMOS-enabled rack-level validation; (4) PCIe 6 scale-up optics demos leveraging COSMOS for end-to-end link management. This is the first time these products will be demonstrated publicly to institutional investors, media, and hyperscaler procurement teams simultaneously. The competing event: MRVL + NVDA joint Computex keynote on June 2 (the day before), titled "The Future of AI Depends on Connectivity." Source: GlobeNewswire / StockTitan, 2026-05-27. *Thesis bearing: Confirms — ALAB is actively competing for the same hyperscaler visibility and design-win narrative as Marvell at the same venue and within 24 hours. The sequence matters: MRVL/NVDA keynote June 2, then ALAB press conference June 3. If MRVL + NVDA anchor the NVLink Fusion connectivity narrative on June 2, ALAB must differentiate on June 3 with COSMOS-enabled demo differentiation and first-mover hyperscaler design wins.*

**NVLink Fusion read-through — NVIDIA endorsing Marvell's connectivity stack at Computex raises ALAB competitive risk:** NVIDIA's $2B investment in Marvell (March 31, 2026) and the joint June 2 Computex keynote ("The Future of AI Depends on Connectivity") position MRVL's NVLink Fusion connectivity platform as the endorsed path for NVIDIA-centric AI factories. Hyperscalers building on NVIDIA infrastructure are being offered a Marvell connectivity stack natively integrated. ALAB's Scorpio X competes for the same scale-up connectivity layer. While ALAB has confirmed Amazon Trainium3 design wins (Scorpio X as the scale-up switch fabric), the NVDA endorsement of MRVL's connectivity products creates an incumbent-adjacent path that ALAB must overcome in future design win cycles. Stock recovered to $324.51 (+1.8%) on May 27 after the -3.8% Northland downgrade on May 26 — institutional support (19 buys / 7 holds / 0 sells) remains intact. Source: NVIDIA Newsroom / HPCwire / price data, 2026-05-27. *Thesis bearing: Challenges — the NVLink Fusion endorsement structurally tilts future NVIDIA-centric design wins toward Marvell; ALAB must defend its position on independently sourced connectivity (non-NVIDIA GPU clusters and open fabric customers). At IV $111.84 and price $324.51 (MoS -65.6%), this is an additional risk at an already stretched valuation.*

---

## Cross-links

- [[NVDA]] — primary indirect customer; Blackwell/Vera Rubin GPU clusters drive ALAB demand; NVLink Fusion endorses MRVL connectivity for NVIDIA-centric racks
- [[MRVL]] — overlapping hyperscaler data center exposure; XConn PCIe 6 + NVLink Fusion now a direct competitive + ecosystem threat to ALAB's Scorpio X
