...
- **Business model:** Integrated device manufacturer (IDM) — designs and manufactures its own memory and storage chips. Revenue = bit shipments × ASP per bit. Gross margin tracks ASP almost directly.
- **Founded:** 1978, Boise, Idaho. HQ still in Boise.
- **Listed:** NASDAQ: MU
- **Fiscal year:** September end (FY2025 = Oct 2024 – Sep 2025)
- **Scale:** ~40,000+ employees. Fabs in Idaho, Virginia, Japan, Singapore, Taiwan.
- **Market cap:** *(update)*

### HBM Thesis Summary
Micron won NVIDIA Blackwell HBM3E design certification — its first time at the front of an HBM generation. HBM earns 5–8x standard DRAM ASP and is contracted (not spot). The binary question: is HBM (currently ~10–15% of bit output) large enough to prevent a FY2023-magnitude trough ($5.8B operating loss) from recurring? If yes, Micron re-rates as a structural grower. If no, it remains a commodity cyclical.

### HBM Market Share (current)
| Supplier | Share | Status |
|---|---|---|
| SK Hynix | ~50% | Dominant; first mover |
| Micron | ~20–25% | Gaining; Blackwell win |
| Samsung | ~25–30% | Quality issues; struggling |

---

## Moat

*(Populate from schema template — DRAM Oligopoly, HBM Design Wins, Process Technology, US Manufacturing Advantage, Scale)*

---

## Financials

*(Pull from Wisesheets — annotate with cycle position when populating. Pull 10Y for cycle context.)*

**Cycle reference points:**
- FY2022 peak: ~$30B revenue, ~47% gross margin
- FY2023 trough: ~$15B revenue, $5.8B operating loss
- FY2024+: recovery underway, HBM accelerating

---

## Revenue Segments

*(Update quarterly — by Business Unit: CNBU, SBU, MBU, EBU; extract HBM detail separately within CNBU)*

---

## Growth Drivers

*(Populate from schema template — HBM Demand, HBM ASP Premium, Data Center DRAM, NAND Enterprise, Automotive, CHIPS Act)*

---

## Risks

*(Populate from schema template — Commodity Cycle, CXMT, Samsung HBM Recovery, AI CapEx Plateau, China Revenue, Balance Sheet)*

---

## Competitor Comparison

*(Populate table: MU vs. SK Hynix vs. Samsung — DRAM share, HBM share, gross margin, CapEx intensity)*
...
### Active Catalysts
*(Populate from schema template — HBM4 qualification, NY fab progress, DRAM ASP stabilization, Samsung HBM, hyperscaler HBM commitments)*
...
*(See schema — Monthly: TrendForce DRAM/NAND price, NVIDIA GPU shipments; Quarterly: HBM revenue %, gross margin, CapEx, DRAM/NAND ASP commentary, bit growth, HBM design wins, China revenue, CHIPS Act; Leading: SK Hynix earnings, NVIDIA data center, hyperscaler CapEx, TrendForce DRAM supply/demand)*

---

## Investment View

*(Populate: cycle-adjusted Valuation, WACC, cycle-normalized DCF, Reverse DCF, Scenarios, Decision Log)*
...
**Samsung strike AVERTED — tentative wage deal reached (CRITICAL UPDATE):** Samsung Electronics' labor union suspended the planned 18-day strike and reached a tentative wage agreement on May 21, averting what would have been the largest semiconductor labor stoppage in history. Central breakthrough: Samsung agreed to delay by one year a contentious bonus distribution method; the chip division receives 40% of the total bonus pool; bonuses partially funded via company stock tied to operating profit targets. Union members vote on the tentative agreement May 22–27. Samsung shares rallied +6% on the news. Source: CNBC / Bloomberg / TechTimes / Digitimes, 2026-05-21. *Thesis bearing: Challenges — the near-term Samsung supply disruption catalyst has been removed. Samsung's HBM4 ramp at Pyeongtaek and Hwaseong can proceed without labor interruption, preserving Samsung's ability to recover market share sooner than expected. However: (1) Micron's HBM is sold out through calendar 2026 regardless of Samsung's production rate — the existing contracted pricing and allocation are unaffected; (2) the tentative deal is subject to member vote (May 22–27) and could still be rejected; (3) the structural demand thesis (NVDA $91B Q2 guide, $725B hyperscaler capex) is fully intact. Net: the largest near-term bullish catalyst for MU supply disruption thesis is removed, but medium-term thesis is unchanged.*
...
### 2026-05-26 (Session 26)

**UBS raises PT to $1,625 — MU crosses $1 trillion market cap (+18% today):** UBS analyst Timothy Arcuri raised Micron's price target from $535 to $1,625 (204% increase) on May 26, making it the new Street high among 46 analysts covering the stock. The upgrade is grounded in: (1) HBM ASP model raised to +50% YoY (vs prior +35% estimate); (2) UBS projects EPS >$100 through 2029 backed by confirmed LTAs with NVIDIA; (3) 2026 HBM4 capacity fully sold out under binding contracts; (4) Micron filling only 50–65% of key customers' medium-term demand. MU surged 18% to ~$894 (intraday high $916.76), crossing $1 trillion market capitalization for the first time in company history. Source: UBS / CNBC / 247WallSt / thetechmarketer.com, 2026-05-26. *Thesis bearing: Strongly confirms — the highest PT upgrade in absolute-dollar terms in semiconductor analyst history validates the structural HBM thesis; $1T market cap milestone reflects consensus shift from cyclical-DRAM to structural-HBM-franchise valuation; LTA visibility through 2029 (as confirmed by UBS) eliminates the near-term cycle downside that previously constrained valuation.*

**TrendForce Q2 2026 DRAM pricing — +58-63% QoQ; memory market 30-50% undersupplied through 2027:** Q2 2026 DRAM contract prices rose 58-63% QoQ (following Q1's record +90-95%). NAND flash rose 70-75% QoQ. Mizuho estimates the memory market is 30-50% undersupplied through 2026-2027. Server RDIMM prices temporarily exceeded HBM contract prices in Q2 due to LTA pricing timing differences. Final mobile DRAM negotiations concluding in May. Source: TrendForce / Yahoo Finance / Mizuho, 2026-05-26. *Thesis bearing: Confirms — the deceleration from +95% to +63% is moderation, not reversal; structural undersupply persisting into 2027 with no capacity relief until late 2027 at earliest; broad-based price increases across all memory types (HBM, server DRAM, mobile DRAM, NAND) confirm supply constraints are not AI-specific but systemic.*
...
- [[NVDA]] — primary HBM customer; Blackwell design win is the revenue anchor
- [[HBM]] — the structural thesis concept
- [[dram-cycle]] — commodity cycle mechanics and history
