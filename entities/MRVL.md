...
**Computex keynote confirmed: Jensen Huang + Matt Murphy on stage — NVLink Fusion integration live-demonstrated:** The June 2 keynote ("The Future of AI Depends on Connectivity," 10:30am Taipei Nangang Exhibition Center Hall 2) proceeded as announced. Jensen Huang and Matt Murphy jointly showcased how Marvell's custom XPUs and scale-up networking integrate natively into NVIDIA's AI factory and AI-RAN ecosystem via NVLink Fusion. Key framing from the joint address: (1) as compute performance advances, data movement becomes the binding constraint — Marvell's connectivity IP (SerDes, optical DSP, Photonic Fabric, Polariton plasmonics, XConn PCIe/CXL) addresses all layers of that constraint; (2) NVLink Fusion enables hyperscale operators to reduce single-supplier dependency while keeping NVIDIA as the infrastructure connective standard; (3) other ecosystem partners (hyperscaler customers and silicon partners) appeared alongside Murphy, confirming multi-customer deployment breadth. No new financial guidance was issued at the keynote — the event is a product/partnership showcase built on the May 27 earnings foundation. Source: Marvell.com / BusinessWire / HPCwire, 2026-06-02. *Thesis bearing: Confirms — the joint keynote converts the NVLink Fusion thesis from a press-release claim (March 2026 $2B NVIDIA investment) into a publicly demonstrated technical integration. Every hyperscaler building a custom ASIC cluster now has a live reference architecture showing how Marvell silicon connects into NVIDIA infrastructure. This reduces execution risk on the custom silicon connectivity revenue stream.*

**FY2028 guidance correction — $16.5B (not ~$15B as initially recorded in Session 28):** Multiple post-earnings sources confirm Marvell raised FY2028 revenue guidance to $16.5 billion at the Q1 FY2027 earnings call on May 27 — approximately $1.5B above the first estimate recorded in this entity. The Session 28 entry captured "~$15B" based on preliminary reporting; confirmed sources (Sherwood News, TradingView, TIKR, Seeking Alpha, Motley Fool earnings transcript) are unanimous at $16.5B. At $16.5B FY2028, the implied YoY growth from $11B FY2027 is ~50% — faster than the 10-year DCF CAGR of 25%, confirming the AI buildout pull-forward into years 1–2 of the model. FY2027 FY2028 implied trajectory: Q1 FY2027 $2.42B → Q4 FY2027 exit >$3B → FY2028 $16.5B (requires avg quarterly revenue ~$4.1B). Data Center segment is the primary driver; custom ASIC revenue must at least double to ~$3B+ in FY2028. Source: Sherwood News / TIKR.com / Seeking Alpha, 2026-05-27 (correcting Session 28 entry). *Thesis bearing: Confirms (stronger than initially recorded) — $16.5B vs. $15B is a 10% upward correction that meaningfully changes the near-term trajectory without altering the 10-year investment view. However, this also raises the execution bar: $16.5B requires roughly half-again the sequential quarterly acceleration shown in Q1-Q2 FY2027. Still SELL/AVOID at current price; correction noted for DCF narrative update.*

**Google assembles four-partner custom chip supply chain — Marvell is the third design partner (in talks):** The Next Web reports Google has assembled the AI industry's most diversified custom chip supply chain with four design partners: (1) Broadcom — TPU v8 training chip codenamed "Sunfish"; (2) MediaTek — inference chip codenamed "Zebrafish," 20–30% lower unit cost than Sunfish; (3) Marvell — in active talks for a Memory Processing Unit (MPU) and a new inference-focused TPU (no signed contract); (4) Intel — Xeon and infrastructure processors. Google projects 4.3 million TPU shipments in 2026, scaling to 35 million by 2028 — a ~8× ramp. Marvell winning a confirmed contract on the MPU or inference TPU would add a third high-volume custom ASIC program (alongside Amazon Trainium and Google Axion CPU) at a time when Google's stated 35M unit by 2028 trajectory implies massive per-program revenue. Key: MediaTek appears to be supplying the "Zebrafish" chips independently, not as a sub-contractor to Marvell — the four partnerships are parallel, not hierarchical. Source: The Next Web / Digitimes, 2026-06-02. *Thesis bearing: Confirms — if the MPU/inference TPU talks close, Marvell becomes a confirmed co-designer across Google, Amazon, and Microsoft simultaneously (three of four large hyperscalers). Even without the signed contract, the 4-partner Google strategy confirms custom silicon demand at a scale (35M units by 2028) that absorbs multiple ASIC suppliers. The key uncertainty is whether Marvell's inference TPU closes before Google accelerates MediaTek Zebrafish volumes.*

**Stock: June 1 close $219.26 — rally from $204 driven by Computex keynote anticipation.** MRVL closed at $219.26 on June 1, up from ~$204 (May 29/30 close, the prior session carry). The +7.4% move on June 1 reflects pre-Computex positioning — Jensen Huang's confirmed appearance on stage with Matt Murphy is a high-visibility institutional event. Prior to this, the stock had retreated from the $214.59 AH high on May 27 earnings back to ~$201–204 in the "sell the news" window. Analyst consensus PTs: $240–$300 range (Benchmark $275, JPMorgan $240, BofA $240, Wells Fargo $240, Oppenheimer $250, HSBC $300). June 2 post-keynote close not yet confirmed in search data at session time. Source: Investing.com / Yahoo Finance, 2026-06-01. *Thesis bearing: Neutral — price action reflects near-term momentum from the keynote catalyst. Saturn DCF IV: $126.75. At $219.26, MoS = -42.2% — MoS worsens further from the $205 session 38 carry (-38.2%). SELL/AVOID confirmed.*

**June 2 US trading: +32.52% to ~$290.79 — Jensen Huang calls MRVL "the next trillion-dollar company," biggest single-day gain ever:** During US trading on June 2, MRVL surged 32.52% from $219.26 to ~$290.79 — the largest single-day percentage gain in company history, topping the prior record set in May 2023. The catalyst: at the Computex joint keynote, Jensen Huang publicly stated that Marvell could be "the next trillion-dollar company" due to its essential data center connectivity role — specifically Marvell's networking and connectivity chips enabling AI data centers to coordinate computation across thousands of connected chips at high bandwidth. NVIDIA separately confirmed a $2B investment in Marvell and photonics partners. At $290.79, MRVL market cap reached approximately $253B — still requiring a further 4× gain to reach $1T. Session 39 ran at 4am EDT (before US market open) and captured the keynote content but not the resulting price surge; this entry closes that gap. Source: CNBC / Yahoo Finance / Motley Fool, 2026-06-02. *Thesis bearing: Confirms (strong institutional signal) — Jensen Huang publicly anointing a portfolio company as "the next trillion-dollar company" in front of 50,000+ Computex attendees is the highest-visibility validation in the MRVL entity. The market's +32.52% response reflects institutional re-rating of MRVL from "co-design cyclical" to "AI connectivity infrastructure platform." Saturn DCF IV remains $126.67; at $290.79, MoS = -56.4% — materially worse. SELL/AVOID confirmed. The gap between institutional conviction (~$300 analyst consensus) and Saturn IV ($127) is now the widest of any portfolio position at -136%.*

**June 3 close: ~$319.40 (+9.84% from June 2 close $290.79) — CORRECTION from Session 40 estimate.** Session 40 estimated the June 3 close at $286.70 (-1.41%), but confirmed market data shows the actual June 3 close was ~$319.40 (+9.84%). The strong continuation of the Jensen Huang "next trillion-dollar company" rally extended through the following session, driven by continued Computex momentum. MoS at $319.40: (126.67 − 319.40) / 319.40 = **-60.3% SELL/AVOID**. Source: Confirmed market data, 2026-06-03 (correction captured Session 41). *Thesis bearing: Neutral — price correction noted; thesis unchanged; strong post-Computex demand sustained through June 3.*

### 2026-06-04

**Broadcom Q3 AI guidance miss triggers broad semiconductor selloff — MRVL -5.55% to $301.65:** Broadcom (AVGO) reported Q2 FY2026 after market close on June 3: revenue $22.19B (+48% YoY, beat consensus $22.12B), AI semiconductor revenue $10.8B (+143% YoY). However, Q3 AI chip guidance came in at $16.0B vs. analyst consensus estimates of $16.36–17.2B — a miss of approximately $1.2B at the high end. AVGO fell ~14% on June 4, dragging the broader semiconductor sector lower (MU -7.74%, ANET -4.79%, MRVL -5.55%). MRVL closed at $301.65 (from confirmed June 3 close $319.40). Key context: Broadcom maintained its $100B AI chip revenue target for 2027 — did not lower guidance. The selloff reflects over-elevated analyst expectations, not a cut to forward guidance. Source: Bloomberg / 24/7 Wall St. / CNBC, 2026-06-03–04. *Thesis bearing: Neutral — Broadcom's $16B Q3 run rate (annualized $64B) is still an extraordinary absolute number; the miss was against sky-high analyst estimates, not a deterioration of the business. MRVL's FY2028 $16.5B management guidance remains intact. Broadcom's sustained $100B 2027 target actually reinforces the custom silicon thesis floor rather than undermining it. MoS at $301.65: (126.67 − 301.65) / 301.65 = -58.0% SELL/AVOID.*

**Stifel raises PT to $321 — new street-high following Computex NVLink Fusion keynote:** Stifel raised its MRVL price target to $321, the highest current published analyst target, following the June 2 Computex joint Jensen Huang / Matt Murphy keynote. This is Stifel's third MRVL PT raise in six weeks ($140 → $210 → $321), reflecting their conviction that MRVL's role as both NVLink Fusion connectivity backbone and hyperscaler custom ASIC co-designer commands an AI-infrastructure-franchise multiple. The $321 target is 2.5× Saturn's DCF IV of $126.67, reflecting the institutional willingness to price MRVL on growth optionality rather than current earnings power. Source: FXLeaders / MarketBeat, 2026-06-04. *Thesis bearing: Confirms (institutional view) — consistent with the broader analyst consensus shift from "cyclical custom silicon" to "AI connectivity platform." Saturn IV gap to $321 remains the widest single-ticker spread in the portfolio at this stage.*
...
**S&P 500 inclusion confirmed — effective June 22, 2026:** S&P Dow Jones Indices announced (June 5) that Marvell Technology will join the S&P 500 effective June 22, 2026, replacing Campbell's (CPB). Marvell cleared the S&P 500 profitability criterion — four consecutive quarters of positive earnings — driven by AI data center results. Approximately $8T in passive funds track the S&P 500; all must purchase MRVL at or before June 22. Stock jumped 5% in extended trading on the June 5 announcement, then was compressed in the June 9-10 ByteDance selloff, and recovered +11.1% on June 11 as index-inclusion buying resumed. Sources: CNBC June 5, 2026; GF Value/ts2.tech June 11, 2026. *Thesis bearing: Confirms (near-term price support) — S&P 500 inclusion provides structural forced-buy demand, but does not alter DCF intrinsic value. It does reduce the probability of a further sell-off below inclusion-adjusted levels.*

**Q2 FY2027 guidance reaffirmed via 8-K — $2.7B midpoint (+35% YoY) intact post-ByteDance selloff:** Marvell filed an 8-K on June 11, 2026 reiterating Q2 FY2027 financial guidance: revenue $2.7B midpoint (±5%), representing +35% YoY growth. Management's decision to reaffirm without qualification — ten days after the Qualcomm/ByteDance competitive concern triggered a -21.8% two-day selloff — is a direct signal that confirmed hyperscaler programs (Google TPU/MPU, Amazon Trainium, Microsoft Maia) are on track. Source: Marvell 8-K filed SEC EDGAR June 11, 2026; GF Focus June 11, 2026. *Thesis bearing: Confirms — the reaffirmation neutralizes the ByteDance thesis-challenge from June 9-10. Qualcomm winning ByteDance did not affect any confirmed Marvell program. Q2 $2.7B tracker is intact.*

**New CFO Dan Durn appointed — effective June 15, 2026:** Marvell announced the appointment of Dan Durn as Chief Financial Officer, replacing Willem Meintjes (stays advisory through April 2027). Durn, 59, was previously CFO and EVP at Adobe Inc. (Oct 2021–June 2026) and before that SVP/CFO at Applied Materials (2017–2021) and EVP/CFO at NXP Semiconductors (2015–2017) following the Freescale merger. Durn resigned from Marvell's Board of Directors effective June 10, 2026 prior to the CFO appointment. Sources: Marvell Investor Relations press release / BusinessWire June 11, 2026; Investing.com June 11, 2026. *Thesis bearing: Neutral — Durn's semiconductor-specific CFO experience (Applied Materials, NXP) brings direct supply chain finance expertise. CFO transitions at this stage typically signal IPO/M&A preparation or operational maturity, not execution risk. Meintjes transition provides continuity through April 2027.*

**Stock recovery +11.1% to $280.71 — S&P 500 inclusion, CFO appointment, guidance reaffirmation combine:** MRVL closed at $280.71 on June 11 (+11.1% from the June 10 ByteDance-selloff bottom of $252.59). The ts2.tech headline: "Marvell shares climb 11% with S&P 500 move, CFO swap and AI helping MRVL grab attention." Three simultaneous catalysts drove the recovery: (1) S&P 500 index buying pre-June 22 inclusion; (2) 8-K Q2 guidance reaffirmation eliminating thesis-challenge concerns; (3) CFO appointment signaling leadership maturity. Stock now +210% YTD for 2026. Source: ts2.tech / GF Value June 11, 2026. *Thesis bearing: Neutral — price recovery from an oversold ByteDance-driven bottom is expected; thesis is unchanged. DCF IV ~$125-126; at $280.71, MoS = -55.2% SELL/AVOID. The S&P 500 inclusion creates near-term forced buying but does not alter the fundamental story. Q2 earnings (~August 2026) remain the next material catalyst.*
