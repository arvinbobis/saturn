...
**June 3 close: ~$286.70 (-1.41%) — post-surge consolidation; ALAB +3.86% on same day.** MRVL gave back 1.41% on June 3 to approximately $286.70 as post-surge profit-taking set in. Notably, ALAB (+3.86%) and MRVL (-1.41%) diverged on the same session day — the market appears to be repricing both as NVLink Fusion connectivity beneficiaries, but with short-term rotation within the connectivity layer. MoS at $286.70: (126.67 − 286.70) / 286.70 = **-55.8% SELL/AVOID**. Source: Market data composite, 2026-06-03. *Thesis bearing: Neutral — one-day consolidation after 32% surge is normal; the institutional validation from Jensen's endorsement is the durable signal, not the day-to-day price action.*
