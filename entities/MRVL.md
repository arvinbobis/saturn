...
**Q1 FY2027 actual results confirmed (Session 28 correction):** Session 27 noted "stock surged 13–15% after hours" — a misattribution. The Stocktwits headline ("MRVL Shares Surge 13% On Solid Q1 Guidance") and TIKR referenced the Q4 FY2026 earnings event (March 5, 2026) when Q1 FY2027 guidance was first issued, not May 27 itself. Actual May 27 results: non-GAAP EPS $0.80 (beat consensus $0.79 by $0.01); revenue approximately $2.40B at or near guidance midpoint (beat consensus by ~$9M; specific number not yet clean-indexed as of session close). After-hours reaction: stock settled ~$214.59, down ~3% from the intraday regular-session high of ~$221, implying a net +7% regular-session move and slight post-earnings consolidation. FY2027 guidance reaffirmed at approaching $11B; FY2028 guidance ~$15B. Q2 FY2027 guidance: approximately $2.3–$2.5B range. Conference call replay passcode 13760544 (available June 2). Source: Investing.com "Marvell earnings beat by $0.01, revenue topped estimates" / MarketBeat / Stocktwits, 2026-05-27. *Thesis bearing: Confirms — clean Q1 beat at guidance midpoint with FY2027/FY2028 multi-year trajectory reaffirmed; the muted after-hours reaction (+3-7% vs. the 13-15% that was anticipated pre-results) is consistent with well-telegraphed results rather than a miss. The thesis is tracking.*

**NVLink Fusion — NVIDIA $2B strategic investment (March 31, 2026) — retroactive addition to Recent Updates:** NVIDIA and Marvell announced a strategic partnership on March 31, 2026. NVIDIA invested $2 billion in Marvell, and Marvell joins the NVLink Fusion ecosystem — a rack-scale platform enabling semi-custom AI infrastructure where Marvell's custom XPUs and NVLink Fusion-compatible scale-up networking integrate directly into NVIDIA's AI factory architecture (Vera CPU, ConnectX NICs, BlueField DPUs, Spectrum-X switches). Additionally, both companies will collaborate on silicon photonics. The partnership was also announced from Marvell's IR page and NVIDIA's newsroom. Note: this was captured in the Growth Drivers section in prior sessions but was absent from the chronological Recent Updates log — corrected here. Source: NVIDIA Newsroom / Marvell IR / Tom's Hardware / CloudNews.tech, 2026-03-31. *Thesis bearing: Strongly Confirms — NVIDIA's $2B investment converts Marvell from a "competing against NVIDIA" custom ASIC story into a platform that benefits from BOTH the NVIDIA-centric and the custom silicon track. NVLink Fusion means hyperscalers can mix-and-match NVIDIA GPUs with Marvell custom accelerators in the same rack — dramatically expanding Marvell's addressable market. The strategic investment also signals NVIDIA views Marvell as a long-term ecosystem partner, not just a competitor.*

**Jensen Huang + Matt Murphy joint Computex 2026 keynote (June 2, 10:30am Taipei) — first joint stage appearance:** NVIDIA CEO Jensen Huang will join Marvell CEO Matt Murphy on stage at the COMPUTEX 2026 keynote on June 2, 2026. Title: "The Future of AI Depends on Connectivity." The session will discuss NVLink Fusion and how the partnership gives hyperscale operators greater choice in AI factory design. This is the first joint public appearance by the two CEOs since the NVLink Fusion partnership was announced March 31. Venue: Taipei Nangang Exhibition Center Hall 2, 7F. Astera Labs' competing Computex press conference is June 3 (first public Scorpio X 320 Lane live demo). Source: HPCwire / PR Newswire / BusinessWire / finance.biggo.com, 2026-05-26. *Thesis bearing: Confirms — a joint stage appearance between the NVIDIA CEO and Marvell CEO elevates the NVLink Fusion partnership from a press release to a product roadmap endorsement; this will drive institutional visibility for Marvell's connectivity and custom silicon positioning in the days immediately following Q1 FY2027 earnings.*
...
- [[NVDA]] — NVLink Fusion + $2B NVIDIA investment: Marvell is now an NVIDIA ecosystem partner AND custom silicon alternative; competitive AND complementary
- [[ANET]] — data center networking; Marvell and Arista serve overlapping infrastructure layer
- [[ALAB]] — XConn acquisition makes Marvell a direct PCIe/CXL switch competitor to Astera Labs; joint Computex keynote creates institutional visibility contrast
