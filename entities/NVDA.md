...
**NVIDIA commits $6.5B to photonics — redefining AI interconnect at the chip level (CNBC, May 29):** NVIDIA has invested at least $6.5B in photonics technology companies since March 2026 in what CNBC characterized as a strategic bet that light-based data movement will replace copper for chip-to-chip and chip-to-memory interconnects inside AI clusters. Key positions: $2B into Lumentum (silicon photonics transceivers), $2B into Coherent (optical connectivity), $2B into Marvell (which owns Inphi photonics IP, integrated into NVLink Fusion), $500M into Corning (optical fiber), and $500M into Ayar Labs' Series E (optical I/O embedded directly in the GPU die). The strategic logic: copper interconnects cap bandwidth density inside GPU clusters — as rack-scale AI systems scale toward NVL72 and beyond, data movement latency and power consumption become the binding constraint. Photonics can deliver 10–100× more bandwidth at significantly lower power per bit than copper at the distances inside an AI rack. Source: CNBC, 2026-05-29. *Thesis bearing: Confirms — NVIDIA is not just a GPU company; the $6.5B photonics investment is a deliberate move to own the physical interconnect layer inside AI factories. Three implications: (1) [[MRVL]] — Marvell's Inphi photonics/optical DSP business (the $10B acquisition target from 2021) becomes even more strategically integrated into NVIDIA's ecosystem; the $2B investment in Marvell simultaneously validates Inphi's technology and deepens the NVLink Fusion lock-in. (2) [[ANET]] — Arista's optical networking business competes with NVIDIA's photonics portfolio at the longer-distance intra-cluster level; this is the first direct competitive signal from NVIDIA into Arista's core networking market. (3) TAM expansion: photonics are not in the current DCF model — as this revenue stream matures (2028+), it could be incremental to data center GPU revenue, not a substitute.*

**N1X ARM laptop chip — final pre-keynote spec leak confirms RTX 5070 Ti-class GPU in a thin-and-light package:** The day before the June 1 Computex keynote, Geekbench data confirmed N1X (also called "N1" in some leaks) features 20 ARM CPU cores at 2.81GHz+, an integrated GPU benchmarking at RTX 5070 Ti-class performance, TSMC N3P process (the same 3nm variant used for Vera Rubin compute dies — not a separate node), TDP range 65–120W, and up to 128GB LPDDR5x-8533 system memory. First production devices target October 2026 limited OEM availability; broad availability early 2027. The chip co-developed with MediaTek targets the 150M/year laptop TAM — every N1X device becomes a native CUDA environment for local AI inference. Source: VideoCardz / WCCFTech / Notebookcheck / Geekbench, 2026-05-30. *Thesis bearing: Confirms — N1X extends the CUDA moat from server rooms into 150M annual consumer devices. TSMC N3P demand read-through: N1X creates an incremental N3P demand stream from NVIDIA supplementing Vera Rubin's CoWoS-N3P demand. The laptop chip is not in the current DCF model; if NVIDIA captures 5–10% of the annual laptop market by 2028–2030, it represents $5–10B incremental annual revenue — material at scale but not immediate.*

**NVDA May 30 close: ~$212.49 (+0.6%) — pre-keynote bounce restores prior levels:** NVDA recovered from the May 29 pullback, estimated close ~$212.49 (intraday range $211.13–$217.86; confirmed basis pending full indexing). The +0.6% move is consistent with pre-Computex positioning. No specific news catalyst — likely photonics/N1X coverage driving sentiment. At $212.49, live MoS = -26.5% vs. DCF IV $156.27 — SELL/AVOID unchanged. June 1 keynote remains the next material catalyst: N1X official specs + OEM partners + "surprise new product" reveal. Source: Market data / intraday ranges, 2026-05-30. *Thesis bearing: Neutral — valuation unchanged; business momentum at peak.*

---

### 2026-06-01

**GTC Taipei keynote — N1X ARM laptop chip officially launched; CUDA arrives on consumer laptops for the first time:** Jensen Huang formally unveiled the NVIDIA N1 / N1X system-on-chip at 11am Taipei time. Co-developed with MediaTek on TSMC N3P, the N1X features a 20-core ARM CPU at 2.81GHz+, an integrated Blackwell GPU with 6,144 CUDA cores (RTX 5070 Ti-equivalent), up to 128GB LPDDR5X-8533 unified memory, and 180–200 AI TOPS. Key significance: the full CUDA developer toolchain — llama.cpp, PyTorch CUDA backend, Flash Attention — runs natively on a laptop without recompilation for the first time. Confirmed OEM partners: ASUS ProArt, Microsoft Surface, Dell XPS, Lenovo (Legion 7, Yoga, IdeaPad), MSI. First devices ship 2026 holiday season; broad availability 2027. MediaTek ceded its Computex keynote slot to NVIDIA. Source: VideoCardz / TechTimes / Tom's Hardware, 2026-05-30/06-01. *Thesis bearing: Confirms — N1X extends the CUDA moat from server racks into 150M+ annual laptop devices. Not in current DCF model; 5–10% laptop market penetration by 2030 = $5–10B incremental annual revenue. TSMC N3P demand read-through: N1X volume creates an incremental N3P demand stream supplementing Vera Rubin's CoWoS-N3P demand.*

**GTC Taipei keynote — Vera Rubin NVL72 confirmed in full production; shipping H2 2026:** Jensen Huang confirmed Vera Rubin NVL72 is in full production and available to customers in H2 2026. Confirmed specs: 36 Vera CPUs + 72 Rubin GPUs per rack, 288GB HBM4 per GPU, NVLink-C2C at 1.8 TB/s bandwidth (2× prior generation, 7× PCIe Gen 6), 10× higher inference performance per watt and 10× lower cost per token vs. H100. Jensen called it "probably the largest product launch in the history of Taiwan" — ~2 million parts per system, 150 ecosystem partners in Taiwan. Won COMPUTEX 2026 Best Choice Award (Golden Award + Sustainable Tech Special Award). Source: NVIDIA Blog / COMPUTEX 2026, 2026-06-01. *Thesis bearing: Confirms — "full production" from the CEO at the keynote is the highest-confidence forward supply signal; Vera Rubin demand is now executing against the $1T Blackwell+Rubin order book. Each NVL72 rack requires CoWoS-L packaging for both GPUs and CPUs — reinforcing the CoWoS capacity doubling Jensen confirmed May 29.*

**GTC Taipei keynote — NVIDIA Constellation campus (Taipei HQ, ~4,000 employees, opens ~2030):** NVIDIA announced the "Constellation" campus as its planned overseas headquarters in Taipei (~4,000 employees, target opening ~2030). Jensen quantified NVIDIA's Taiwan investment at $100B/year currently — up from $10–15B/year five years ago — covering TSMC wafers, CoWoS, MediaTek co-design, and 150 supply chain partners. Source: Tribune.net.ph / CryptoBriefing / NVIDIA, 2026-05-26/06-01. *Thesis bearing: Confirms — the campus deepens the structural Taiwan commitment that underlies the CoWoS chokepoint thesis and makes the TSMC relationship irreplaceable on any 5–10 year horizon.*

**Texas Instruments + NVIDIA Robotics Partnership (GTC):** TI announced integration of its real-time motor control, sensing, and power management tech with NVIDIA's Jetson Thor edge AI platform (2,070 FP4 TFLOPS) for humanoid robot deployment. NVIDIA's physical AI stack — Jetson Thor at edge, Vera Rubin in cloud, Isaac Lab for training — now has 150+ ecosystem partners. Source: TradingKey / GTC 2026, 2026-06-01. *Thesis bearing: Confirms — robotics is the next compute TAM expansion; each humanoid robot requires both edge inference (Jetson) and cloud training (Vera Rubin), adding a recurring hardware cycle on top of data center AI.*
