...
**HBM4 now 26% of Vera Rubin NVL72 rack cost ($2M of $7.8M total); Samsung tapped as second HBM4 supplier alongside SK Hynix** — Pre-Computex supply chain data shows HBM4 + LPDDR5X together account for $2M of the $7.8M total Vera Rubin NVL72 rack cost — a 435% HBM price surge driven by scarcity (Rubin production cut from 2M to 1.5M units). SK Hynix holds ~70% of Vera Rubin HBM4 allocation; Samsung has been added as second supplier (with yields estimated at ~60%, declining after back-end processing). Micron's allocation for Vera Rubin NVL72 remains secondary (behind SK Hynix and Samsung for the flagship rack), but Micron is targeted for Rubin CPX (the mid-tier variant). TrendForce cut Rubin shipment share forecast from 29% to 22% of 2026 AI accelerators. — At $2M HBM per rack and 1.5M rack-equivalent units, the 2026 HBM4 TAM just for Vera Rubin is ~$3B — a significant incremental demand pool on top of Blackwell HBM3E. Samsung's second-supplier role raises competition risk for SK Hynix's pricing premium, but also validates that HBM4 production at scale requires all three suppliers.
