...
**TrendForce Q2 2026 DRAM pricing: conventional +58–63% QoQ; mobile DRAM +93–98% QoQ; structural supply tightness through late 2027** — TrendForce's Q2 2026 DRAM pricing report (published March 31, 2026; confirmed in May color) shows conventional DRAM contract prices rising +58–63% QoQ in Q2 2026, mobile DRAM +93–98% QoQ (some mobile DRAM LTAs signed at $21/GB). NAND flash also +70–75% QoQ. The structural drivers: (1) suppliers redirecting capacity to HBM and high-margin server DRAM, creating conventional DRAM scarcity; (2) cloud service providers accelerating AI inference workload deployment and securing supply via multi-year LTAs; (3) consumer segments (smartphone/notebook) experiencing affordability-driven demand cuts, reducing the pressure that historically absorbs excess capacity. ASML: 60+ EUV unit 2026 shipment target, with 51% going to memory customers (SK Hynix, Samsung) — confirming sustained capital commitment to expand DRAM capacity. Meaningful new supply not expected until late 2027. Source: TrendForce presscenter / Tom's Hardware / TechPowerUp, 2026-03-31 to 2026-05-20. — At +58–63% QoQ conventional DRAM pricing, the 2023-cycle DRAM trough (negative gross margins across the industry) is structurally inaccessible in 2026; any "cycle peak" narrative must explain where the demand destruction comes from when AI inference is the primary buyer and is price-inelastic and capex-committed. This is the strongest single data point validating the "HBM breaks the commodity cycle" thesis.
